  ...
  <div class="container-fluid">
    ...
    <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdown">
            ...
            <li><a class="dropdown-item" href="studentsview.php " style="color:black;" ><i class="bi bi-clipboard-data" ></i> Students View</a></li>
             <li><a class="dropdown-item" href="adminprofile.php"  style="color:black;"><i class="bi bi-person-fill"></i> Admin Profile</a></li>
            <li><a class="dropdown-item" href="studentgrades.php"  style="color:black;" ><i class="bi bi-bar-chart-line-fill"></i> Grades</a></li>
            <li><a class="dropdown-item" href="subjects.php"   style="color:black"><i class="bi bi-journal-text"></i> Subjects</a></li>
            <hr />
